...
const faqs = [
  ...
  },
  {
    ...
    a: "Click a session row in the Active Sessions tab to see connection details. Configure your application to use a SOCKS5 proxy at 127.0.0.1:1082 with the session ID as username and your session token as password. Example: curl --socks5 127.0.0.1:1082 --proxy-user SESSION_ID:TOKEN https://example.com",
  },
  {
